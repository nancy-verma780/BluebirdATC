...
class SectorIEnv(BaseEnv):
    ...
    Artificially generated aircraft scenarios and a configurable I sector
    ...
    def __init__(
        ...
        if len(airspace_sectors) == 1 and airspace_sectors[0] == "sector_i":
...
if __name__ == "__main__":
    ...
    config = SectorIEnv.get_default_env_config(view)
