...
class SectorXEnv(BaseEnv):
    """gymnasium environment for the X sector airspace.

    Artificially generated aircraft scenarios and a configurable X sector
    ...
    def __init__(
        ...
        super(SectorXEnv, self).__init__(
            render_mode,
            config,
        )
    ...
    def _generate_scenario(self) -> Simulator:
        ...
        category = "Artificial"
        scenario = "X-Sector-Custom-Scenario"
...
if __name__ == "__main__":
    ...
    config = SectorXEnv.get_default_env_config(view)
