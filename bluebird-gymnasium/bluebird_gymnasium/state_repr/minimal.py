...
class MinimalRepresentationRaw(BaseRepresentation):
    ...
    |   1 | Aircraft distance from the    |-inf | inf  | Nautical Miles (NM) |
    ...
    def __init__(
        ...
        base_feats_high = [2 * np.pi, np.inf]
...
class MinimalRepresentation(BaseRepresentation):
    """Representation of aircraft state in the simulator.
    ...
    |   1 | Aircraft distance from the    |-3.0 | 3.0  | Nautical Miles (NM) |
    ...
    | Num |         Observation           | Min | Max  |        Unit         |
    +-----+-------------------------------+-----+------+---------------------+
    |   0 | *Bearing from aircraft route's|-pi  | pi   | Angle (radians)     |
    |     | previous to next fix          |     |      |                     |
    |   1 | Relative angular difference   |-pi  | pi   | Angle (radians)     |
    |     | between aircraft heading and  |     |      |                     |
    |     | the bearing from aircraft     |     |      |                     |
