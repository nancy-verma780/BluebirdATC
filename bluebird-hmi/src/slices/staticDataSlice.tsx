...
export const selectExists = (state: RootState): boolean => state.staticData.exists;
export const selectScenarioName = (state: RootState): string => state.staticData.scenarioName;
export const selectFixes = (state: RootState): Fix[] => state.staticData.fixes;
export const selectSectors = (state: RootState): Record<string, Coordinate[][]> => state.staticData.sectors;
export const selectProjectionCentre = (state: RootState): [number, number] | null => state.staticData.projection_centre;
