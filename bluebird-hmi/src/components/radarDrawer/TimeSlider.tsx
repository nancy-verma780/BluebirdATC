...
const TimeSlider = () => {
    ...
    const handleChange = (event) => {
        ...
        const interpolatedSeconds = endDateTimeInSeconds + (value / 600 - 1) * totalDurationInSeconds;
    ...
    return (
        <MenuList disablePadding sx={{ mt: 0.75, alignItems: "center", display: 'flex', flexDirection: 'column', }}>
