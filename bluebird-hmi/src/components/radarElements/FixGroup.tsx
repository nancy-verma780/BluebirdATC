...
export default function FixGroup(props: FixGroupProps) {
    ...
    useEffect(() => {
        ...
        const fixSelection = fixGroup.selectAll(".fix").data(fixData, (d: FixWithCoords) => d.name);
        ...
        fixSelection
            ...
            .attr("fill", (d) =>
                d.name.length === 4 && scenarioName !== "ATC Game vs Falcon" ? "none" : colourProfile["fixColour"],
            )
    ...
    }, [colourProfile, lineWidthProfile, showFixNames, fixes, projection, scenarioName, fixData]);
