...
import { Aircraft, ColourProfile, LineWidthProfile, OpacityProfile, ToolCallsignStore } from "utils/types";
import { getRangeRingPixelRadius, nauticalMilesToKm } from "utils/DistanceUtils";
...
export default function AircraftRangeRingsGroup(props: AircraftRangeRingsGroupProps) {
    const {
        toolCallsigns,
        colourProfile,
        opacityProfile,
    ...
    const filteredAircraft = useMemo(
        () => allAircraft.filter((aircraft) => toolCallsigns.rangeRings.includes(aircraft.callsign)),
            ...
            .join(
                (enter) =>
                    enter
                        ...
                        .attr("r", (aircraft: Aircraft) => memoizedGetRangeRingPixelRadius(aircraft))
    ...
    return <g id="aircraftRangeRingsGroup" className="aircraft-range-rings-group" />;
}
